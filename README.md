...
<ul>
 <li>After we found the correct color of the pixel (red which is (0,16-23,0)), we did not know where to go from there. The documentation and google was not very helpful for us to solve it </li>
